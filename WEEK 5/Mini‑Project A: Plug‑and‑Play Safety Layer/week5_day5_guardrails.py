...
if __name__ == "__main__":
    ...
    # Load externalized policy from YAML before running demo (path relative to this file)
    from pathlib import Path
    _yaml_path = Path(__file__).parent.parent / "MiniProjectB_YAMLPolicy_and_RuntimeThresholds" / "safety_policy.yaml"
    load_policy(str(_yaml_path))
